...
import 'package:social/auth/register/register.dart';
import 'package:social/components/stream_grid_wrapper.dart';
import 'package:social/models/post.dart';
import 'package:social/models/user.dart';
import 'package:social/screens/edit_profile.dart';
import 'package:social/screens/list_posts.dart';
import 'package:social/screens/settings.dart';
import 'package:social/utils/firebase.dart';
import 'package:social/widgets/post_tiles.dart';
...
class _ProfileState extends State<Profile> {
  ...
  Future<String?> fetchProfileUrl(String profileId) async {
    try {
      // Fetch the user document from Firestore using the profileId (userId)
      DocumentSnapshot userDoc = await FirebaseFirestore.instance
          .collection('users')
          .doc(profileId)
          .get();

      // Check if the document exists and fetch the 'profileUrl' field
      if (userDoc.exists) {
        return userDoc['profilePicture']; // Return the profile picture URL
      } else {
        print("User not found");
        return null; // Return null if the user does not exist
      }
    } catch (e) {
      print('Error fetching profile URL: $e');
