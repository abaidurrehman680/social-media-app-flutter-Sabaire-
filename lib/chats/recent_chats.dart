...
import 'package:social/components/chat_item.dart';
...
class _ChatsState extends State<Chats> {
  ...
  void initState() {
    super.initState();
    // Call setUser here to avoid calling it during build
                  ...
                  return StreamBuilder<QuerySnapshot>(
                    ...
                    builder: (context, snapshot) {
                      if (snapshot.hasData) {
                        ...
                        // Remove the current user's id from the Users list so we can get the second user's id
